...
include get_template_directory().'/includes/admin/custom-post-type/custom-post-type.php';
...
include get_template_directory().'/includes/frontend/tuyendung/order_tuyendung.php';
...
function the_breadcrumb()
{
    ...
    if (    is_home()
        ...
        if ( is_paged() ) {
            $breadcrumb_output_link .= '<a href="' . $home_link . '" class="br_home">' . $home_text . '</a>';
            $breadcrumb_output_link .= $page_addon;
        }
    } else {
        $breadcrumb_output_link .= '<a href="' . $home_link . '" rel="v:url" property="v:title" class="br_home" >' . $home_text . '</a>';
